...
with stem.control.Controller.from_port() as controller:
  ...
  print("Mermory usage: %s (resident_size) " % stem.util.proc.get_memory_usage(pid=tor_pid)[0])
  print("Mermory usage: %s (virtual_size) " % stem.util.proc.get_memory_usage(pid=tor_pid)[1])
